...
import { LuX, LuCircleCheck, LuRefreshCw } from "react-icons/lu";
  ...
  return (
    <li>
      <div className="file-icon">
        {fileIcons[getFileExtension(fileData.file?.name)] ?? <FaFile size={14} color="#718096" />}
      </div>
      <div className="file">
        <div className="file-details">
          ...
          {isUploaded ? (
            <LuCircleCheck title={t("uploaded")} className="upload-success" />
          ) : isCanceled || uploadFailed ? (
            <LuRefreshCw className="retry-upload" title="Retry" onClick={handleRetry} />
          ) : (
            <div
              className="rm-file"
